...
class custom_menu extends custom_menu_item {
     ...
     *
     */
    public static function user_cohorts($userid) {
        global $CFG, $DB;
...
*/
     ...
     *     Student only|http://c.pl|Studnet|pl|student
     *
     *
     * @static
    ...
    public static function convert_text_to_menu_nodes($text, $language = null) {
        ...
        foreach ($lines as $linenumber => $line) {
            ...
            if ($cohortonly) {
                $showmenu=false;
                $cohortonly = explode(',',$cohortonly);
                $usercohorts = self::user_cohorts($USER->id);
                if ($usercohorts) {
                    foreach ($usercohorts as $cohort) {
                        if (in_array($cohort->idnumber, $cohortonly)) {
                            $showmenu=true;
                        }
                    }
                }
